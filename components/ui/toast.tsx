...
// Sonner-style sugar on top of Base UI's manager. `manager.add()` already
// upserts in place when passed an existing `id` (used by the autosave
// status toast in blog-form.tsx), so these just fill in `type`.
type ToastOptions = Omit<Parameters<typeof manager.add>[0], 'title' | 'type'>

function show(type: string, title: React.ReactNode, options?: ToastOptions) {
