    ...
    <div className="container mx-auto max-w-3xl px-4 py-16">
      ...
      <nav className="mb-12 rounded-xl border bg-muted/40 p-6">
        ...
        <ol className="space-y-1.5 text-sm">
          {[
            ...
            ['#detailed-processing', 'IV. Detailed Information on the Processing of Personal Data'],
            ['#user-rights', 'V. The Rights of Users'],
            ['#additional-info', 'VI. Additional Information about Data Collection and Processing'],
      ...
      <article className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          ...
          third parties, there are: Cookies and Usage Data.
        </p>
        <p>
        ...
        <p>
          ...
          transfers may involve transferring the User's Data to a country other than their own.
        </p>
        <h3>Retention time</h3>
        <p>
          Personal Data shall be processed and stored for as long as required by the purpose they
          have been collected for. Once the retention period expires, Personal Data shall be deleted.
        </p>
        ...
        <p>
          ...
          well as for the following purposes: Analytics, Registration and authentication, and
        ...
        <h3>Analytics</h3>
        <p>
          Google Analytics is a web analysis service provided by Google Inc. Google utilizes the
          Data collected to track and examine the use of this Application and prepare reports on its
          activities. Personal Data collected: Cookies and Usage Data. Place of processing: United
          States —{' '}
        ...
        <p>
          GitHub OAuth is a registration and authentication service provided by GitHub Inc. Place of
        ...
        <p>
          Google OAuth is a registration and authentication service provided by Google Inc. Place of
          processing: United States —{' '}
          <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">
            Privacy Policy
          </a>
        ...
        <ul>
          ...
          <li>
            <strong>Object to processing of their Data.</strong> Users have the right to object to
          ...
          <li>
            ...
            processed by the Owner and obtain a copy of the Data undergoing processing.
          </li>
          <li>
          ...
          <li>
            <strong>Restrict the processing of their Data.</strong> Users have the right, under
          ...
          <li>
            ...
            right, under certain circumstances, to obtain the erasure of their Data from the Owner.
          </li>
          <li>
        ...
        <p>
          ...
          collect files that record interaction with this Application (System logs) and use other
        ...
        <p>
          ...
          notice to its Users on this page. It is strongly recommended to check this page often,
        ...
        <p>
          This Application uses Algolia for full-text search functionality. Search queries may be
          processed by Algolia's servers. For more information, please refer to{' '}
          <a
        ...
        <p>
          Images and static assets are served via AWS S3 and a CDN. Access logs may be retained
        ...
        <p>
          Any information that directly, indirectly, or in connection with other information allows
          for the identification or identifiability of a natural person.
        </p>
        <h3>Usage Data</h3>
        <p>
          Information collected automatically through this Application, which can include: IP
          addresses, URI addresses, time of the request, browser and operating system details, and
          other parameters about the User's IT environment.
        </p>
        <h3>User</h3>
        <p>
